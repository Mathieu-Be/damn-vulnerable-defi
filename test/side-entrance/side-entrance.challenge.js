...
describe('[Challenge] Side entrance', function () {
    ...
    it('Exploit', async function () {
        const SideEntranceLenderDrainer = await ethers.getContractFactory('SideEntranceLenderDrainer', deployer);
        this.drainer = await SideEntranceLenderDrainer.connect(attacker).deploy(this.pool.address);
